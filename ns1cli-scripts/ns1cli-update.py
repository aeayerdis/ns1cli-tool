...
def ns1cli_update(argv):
    ...
    for opt, arg in opts:
        if opt == '-h':
            ...
            print()
            print(
                'Usage: Updates Record Answer Value of an existing Record:' + "\n"
                'ns1cli-update  -r <record> -t <record_type> -a <updated_answer>'
            )
            print()
            sys.exit()
